  ...
  retrieveAll: async (req, res) => {
    ...
    try {
      ...
      if (modelResponse.status) {
        ...
        response.message = 'Nfc cards found!';
        response.data = modelResponse.data;
      } else {
        response.status = statusCodes.notFound;
        response.message = 'No nfc cards found.'
      }
    } catch (err) {
      console.log('ERROR-NfcCardController-retrieveAll: ', err);
      response.error = err;
    }
  ...
  retrieveOne: async (req, res) => {
    ...
    try {
      ...
      if (modelResponse.status && modelResponse.data) {
        response.status = statusCodes.ok;
        response.message = 'Nfc card found!';
        response.data = modelResponse.data;
      } else {
        response.status = statusCodes.notFound;
        response.message = 'Nfc card not found.';
      }

    } catch (err) {
      console.log('ERROR-NfcCardController-retrieveOne: ', err);
      response.error = err;
    }
    res.status(response.status).send(response);
  },
  ...
  create: async (req, res) => {
    ...
    try {
      ...
      if (modelResponse) {
        ...
        response.message = 'Nfc card created successfully!';
        response.data = modelResponse.data;
      }
    } catch (err) {
      console.log('ERROR-NfcCardController-create: ', err);
    }
  ...
  update: async (req, res) => {
    ...
    try {
      ...
      if (modelResponse && modelResponse.data) {
        response.status = statusCodes.ok;
        response.message = 'Nfc card updated successfully!';
        response.data = modelResponse.data;
      } else {
        response.status = statusCodes.notFound;
        response.message = 'Nfc card not found.';
      ...
      console.log('ERROR-NfcCardController-update: ', err);
    }
  ...
  delete: async (req, res) => {
    ...
    try {
      ...
      if (modelResponse.status && modelResponse.data) {
        ...
        response.message = 'Nfc card deleted successfully!';
      } else {
        response.status = statusCodes.notFound;
        response.message = 'Nfc card not found';
      }
    } catch (err) {
      console.log('ERROR-NfcCardController-delete: ', err);
    }
